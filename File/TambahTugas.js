...
export default function TambahTugas({ navigation }) {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.boxJadwal}>
          ...
          <Picker
            ...
            onValueChange={(itemValue, itemIndex) =>
              setRepeatSelectedValue(itemValue)
            }>
      ...
      <TouchableOpacity style={styles.buttonboxbuat} onPress={submit}>
